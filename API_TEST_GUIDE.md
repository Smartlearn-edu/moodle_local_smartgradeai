...
2. **URL**: `https://smartlearn.education/webservice/rest/server.php?wstoken=2550a2cd0b216f02a5e2e50192698a90&wsfunction=local_smartgradeai_save_rubric_grade&moodlewsrestformat=json`
...
`https://smartlearn.education/webservice/rest/server.php?wstoken=2550a2cd0b216f02a5e2e50192698a90&wsfunction=local_smartgradeai_save_rubric_grade&moodlewsrestformat=json&assignmentid=13&userid=15&rubric_data[0][criterionid]=11&rubric_data[0][levelid]=33&rubric_data[0][remark]=First_feedback&rubric_data[1][criterionid]=12&rubric_data[1][levelid]=37&rubric_data[1][remark]=Second_feedback`
...
```bash
curl --location 'https://smartlearn.education/webservice/rest/server.php?wstoken=2550a2cd0b216f02a5e2e50192698a90&wsfunction=local_smartgradeai_save_rubric_grade&moodlewsrestformat=json' \
